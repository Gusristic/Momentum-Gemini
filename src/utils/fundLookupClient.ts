...
export const AUDITED_ISIN_CATALOG: Record<string, Partial<FundLookupResult>> = {
  ...
  'LU1278917452': {
    ...
    source: 'DWS / Morningstar (12M: 22.76% | YTD: 17.00% | 6M: 2.23% | 3M: 4.37%)',
  },
  ...
  // Vanguard Emerging Markets Stock Index EUR
  'IE0031786142': {
    ...
    source: 'Morningstar / Vanguard (12M: 31.47% | 3A Anualizado: 19.17%)',
  },
  // Vanguard Emerging Markets Stock Index Fund EUR (Class Acc)
  'IE0031442068': {
